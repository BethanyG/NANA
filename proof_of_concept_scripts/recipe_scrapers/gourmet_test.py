...
html = urlopen("http://www.gourmet.com/recipes/gourmetlive/2011/071511/sesame-soy-flank-steak-recipe.html") 
...
if bsObj.find("div", {"class":"text"}):
    ...
    description = [''.join(item.split('<em>')) for item in bsObj.find("div", {"class":"text"}).contents]
...
servings_I = ''.join(bsObj.find("div", {"class":"yield"}).getText().strip())
cooktime = ' '.join(bsObj.find("ul", {"class":"time"}).getText().split())
...
#http://www.gourmet.com/recipes/2000s/2006/12/pizza-with-fontina-proscuitto-and-arugula.html
#http://www.gourmet.com/recipes/2000s/2009/01/spaghetti-and-meatballs.html
#http://www.gourmet.com/recipes/2000s/2008/07/beeftenderloin.html
#http://www.gourmet.com/recipes/gourmetlive/2011/071511/sesame-soy-flank-steak-recipe.html